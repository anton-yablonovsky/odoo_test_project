...
class ManagerSerializer(serializers.ModelSerializer):
    buildings = serializers.PrimaryKeyRelatedField(queryset=Building.objects.all(), many=True, required=False)
...
class GuardSerializer(serializers.ModelSerializer):
    entrances = serializers.PrimaryKeyRelatedField(queryset=Entrance.objects.all(), many=True, required=False)
...
class InhabitantSerializer(serializers.ModelSerializer):
    apartments = serializers.PrimaryKeyRelatedField(queryset=Apartment.objects.all(), many=True, required=False)
