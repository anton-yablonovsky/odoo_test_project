...
export const useStore = defineStore("store", {
  ...
  actions: {
    ...
    async logout() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/logout",
          {
            method: "POST",
            headers: {
              "X-CSRFToken": getCSRFToken(),
    ...
    async isAuthenticated() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/user/is_authenticated/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getUserRole() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/get_user_role/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getBuildings() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/get_buildings_list/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getEntrances() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/get_entrances_list/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getApartments() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/get_apartments_list/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getUsers() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/get_users_list/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getManagerBuildings() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/manager_buildings/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getGuardEntrances() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/guard_entrances/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
    ...
    async getInhabitantApartments() {
      try {
        const response = await fetch(
          "http://localhost:8000/backend/api/inhabitant_apartments/",
          {
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
