...
export default {
  ...
  methods: {
    async submitInhabitantForm() {
      ...
      try {
        await axios.post(
          "http://localhost:8000/backend/api/add_inhabitant/",
          inhabitant,
          {
            headers: {
...
<template>
  <div class="manage-users">
    ...
    <div class="create-inhabitant-page">
      ...
      <form @submit.prevent="submitInhabitantForm" class="inhabitant-form">
        ...
        <div class="form-group">
          ...
          <input
            v-model="this.inhabitant_username"
            type="text"
            id="inhabitant_username"
            required
          />
        </div>
        ...
        <div class="form-group">
          ...
          <input
            v-model="this.inhabitant_password"
            type="password"
            id="inhabitant_password"
            required
          />
        </div>
        ...
        <div class="form-group">
          ...
          <select
            v-model="this.inhabitant_apartments"
            id="inhabitant_apartments"
            multiple
          >
            <option
    ...
    <div class="delete-user">
      ...
      <ul>
        <label for="userSelect">Select Inhabitant</label
        ><br />
