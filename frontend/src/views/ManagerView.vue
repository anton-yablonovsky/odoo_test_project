...
export default {
  ...
  methods: {
    async submitManagerForm() {
      ...
      try {
        await axios.post(
          "http://localhost:8000/backend/api/add_manager/",
          manager,
          {
            headers: {
    ...
    <div class="create-manager-page">
      ...
      <form @submit.prevent="submitManagerForm" class="manager-form">
        ...
        <div class="form-group">
          ...
          <select
            v-model="this.manager_buildings"
            id="manager_buildings"
            multiple
          >
            <option
